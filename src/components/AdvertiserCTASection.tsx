  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 md:px-8 max-w-[95%] sm:max-w-[600px] md:max-w-[900px] lg:max-w-[1000px] mx-auto">
        ...
        `}>
          Your buyers are having <span className="gradient">conversations right now.</span>
        </h2>
        ...
        `}>
          High-intent moments happen in LLM chats, not just search. Gravity reaches users at the exact second they're deciding.
        </p>
